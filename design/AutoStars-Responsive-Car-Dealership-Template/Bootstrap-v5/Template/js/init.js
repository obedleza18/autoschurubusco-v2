...
================================================== */
	AUTOSTARS.SuperFish = function() {
		...
		$(".dd-menu > ul > li:has(ul)").find("a:first").append(" <i class='fas fa-angle-down'></i>");
		$(".dd-menu > ul > li > ul > li:has(ul)").find("a:first").append(" <i class='fas fa-angle-right'></i>");
		$(".dd-menu > ul > li > ul > li > ul > li:has(ul)").find("a:first").append(" <i class='fas fa-angle-right'></i>");
	}
/* ==================================================
   Header Functions
================================================== */
...
$(document).ready(function(){
	...
	$(".listing-form-steps li").on("click", function(){
		...
		$('.listing-step-container').hide();
		var Target = $(this).attr('data-target');
		$(Target).fadeIn();
	});
	$(".listing-step-tabs .nav-tabs li a").on("click", function(e){
		$(".listing-step-tabs .nav-tabs li").removeClass("active");
		$(this).parent('li').addClass("active");
		$('.listing-data-type').hide();
		var TargetType = $(this).attr('href');
		$(TargetType).fadeIn();
		e.preventDefault();
	});
	$(".listing-form-steps li a").on('click',function(e){
		e.preventDefault();
	});
	...
	$('.search-advanced-trigger').on("click", function() {	
		if ($(this).hasClass('advanced')) {
			...
			$(this).html('Basic Search <i class="fas fa-arrow-up"></i>');
		} else {
			
			$(this).addClass('advanced');
			$(".advanced-search-row").slideUp();
			$(this).html('Advanced Search <i class="fas fa-arrow-down"></i>');
		}	
		return false;
	});
...
$(window).on('load',function(){
	...
	$(".format-link").each(function(){
		$(this).find(".media-box").append("<span class='zoom'><span class='icon'><i class='fas fa-link'></i></span></span>");
	});
	$(".additional-images .owl-carousel .item-video").each(function(){
		$(this).append("<span class='icon'><i class='fas fa-play'></i></span>");
	});
	AUTOSTARS.StickyHeader();
});

// Icon Append
$('.basic-link').append(' <i class="fas fa-angle-right"></i>');
$('.basic-link.backward').prepend(' <i class="fas fa-angle-left"></i> ');
$('ul.checks li, .add-features-list li').prepend('<i class="fas fa-check"></i> ');
$('ul.angles li, .widget_categories ul li a, .widget_archive ul li a, .widget_recent_entries ul li a, .widget_recent_comments ul li a, .widget_links ul li a, .widget_meta ul li a').prepend('<i class="fas fa-angle-right"></i> ');
$('ul.chevrons li').prepend('<i class="fas fa-chevron-right"></i> ');
$('ul.carets li, ul.inline li, .filter-options-list li').prepend('<i class="fas fa-caret-right"></i> ');
